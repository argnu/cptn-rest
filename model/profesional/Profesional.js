      ...
      if (r.rows[0]) {
        ...
        return getDatosProfesional(profesional, rol)
          .then(([
            ...
            // Se ordenan las formaciones:
            // 1. Alfabéticamente
            // 2. Por tipo de matrícula (número, ascendente)
            // 3. Si es título principal (bool)
            formaciones = formaciones
              .sort((a, b) => (a.titulo.nombre).localeCompare(b.titulo.nombre))
              .sort((a, b) => a.titulo.tipo_matricula - b.titulo.tipo_matricula)
